...
#6
s=slide();title(s,'Impact + ask','Pilot one district. Prove earlier verification. Scale through existing systems.');card(s,.65,1.95,3.8,2.2,'1','Pilot','Partner with one Raigad dairy network + district veterinary office. Measure time from first signal to field verification.');card(s,4.75,1.95,3.8,2.2,'2','Validate','Track false alerts, sensitivity, farmer completion, officer response and confirmed outcomes.',SAGE);card(s,8.85,1.95,3.8,2.2,'3','Integrate','Import Bharat Pashudhan Tag ID; export NADRS-format reports; expand district by district.',GOLD);rect(s,.65,4.55,12,1.1,RGBColor(243,225,215),RGBColor(232,190,172));text(s,1,4.84,11.3,.48,'Ask: pilot access to anonymised village dairy aggregates, field validation and district workflow feedback.',20,ACC,True,'Georgia',PP_ALIGN.CENTER);text(s,.65,6.12,12,.45,'Safety: decision support only · veterinarian confirmation · DPDP-aware access controls · synthetic prototype data disclosed',11,MUT,align=PP_ALIGN.CENTER);footer(s,6)
